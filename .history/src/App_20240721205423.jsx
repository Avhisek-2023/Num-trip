              ...
              <div
                className={
                  e == 2
                    ...
                    : " px-6 py-4 m-1 text-xl font-bold text-center transition duration-300 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200"
                }
                key={j}
