...
const App = () => {
  ...
  //       for (let i = 0; i < twoDValue.length; i++) {
  //         for (let j = 0; j < twoDValue[i].length; j++) {
  //           if (twoDValue[i][j] === chosenArray[k]) {
  //             return true;
  //           }
  //         }
  //       }
  ...
  const nameClass = (e) => {
    if (e == 2) {
      return "px-6 py-4 m-1 text-xl text-red-500 font-bold text-center transition duration-500 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200";
    } else if (e == 4) {
      return "px-6 py-4 m-1 text-xl text-yellow-500 font-bold text-center transition duration-500 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200";
    } else {
      return "px-6 py-4 m-1 text-xl text-green-500 font-bold text-center transition duration-500 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200";
    }
  };
  return loading ? (
    <>Loading..</>
    ...
    <div className="container flex flex-col items-center justify-center w-full h-auto my-40">
      <div className="p-2 border-4 shadow-2xl shadow-cyan-900 border-cyan-800 bg-slate-300 rounded-xl">
        {twoDValue.map((row, i) => (
