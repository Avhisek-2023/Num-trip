    ...
    <div className="container w-full h-auto flex flex-col items-center my-40">
      {/* <div className="flex flex-row flex-nowrap h-8">
        <div
          ...
          ref={(div) => (matrixRef.current[0][0] = div)}
        ></div>
        <div
          className="w-12  border-2 border-red-400 text-center"
          ref={(div) => (matrixRef.current[0][1] = div)}
        ></div>
        <div
          className="w-12  border-2 border-red-400 text-center"
          ref={(div) => (matrixRef.current[0][2] = div)}
        ></div>
        <div
          className="w-12  border-2 border-red-400 text-center"
          ref={(div) => (matrixRef.current[0][3] = div)}
        ></div>
        <div
          className="w-12  border-2 border-red-400 text-center"
          ref={(div) => (matrixRef.current[0][4] = div)}
        ></div>
      </div>
      <div
