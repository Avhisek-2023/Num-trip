    ...
    <div className="container flex flex-col items-center justify-center w-full h-auto my-40">
      {twoDValue.map((row, i) => (
        <div className="flex w-1/2 lg:w-1/4 " key={i}>
          {row.map((e, j) => (
            <div
              className="px-6 py-4 transition  duration-300   hover:bg-indigo-500 ease-in-out text-xl font-bold text-center bg-blue-100 border-2 border-blue-900 cursor-pointer"
              key={j}
