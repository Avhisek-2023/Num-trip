          ...
          <div className="flex w-1/2 lg:w-full " key={i}>
            {row.map((e, j) => (
              <div
                className={
                  nameClass(e) +
                  "px-6 py-4 w- m-1 text-xl font-bold text-center transition duration-500 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200"
                }
                key={j}
