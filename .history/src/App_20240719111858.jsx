...
const App = () => {
  ...
  useEffect(() => {
    ...
    // console.log(matrixRef.current[0][0]);
  }, []);
  ...
  return (
    <div className="container w-full h-auto flex flex-col items-center my-40">
      ...
      >
        <div className="w-12  border-2 border-red-400 text-center" ref={(div) => (matrixRef.current[0][0] = div)}></div>
        <div className="w-12  border-2 border-red-400 text-center"  ref={(div) => (matrixRef.current[0][1] = div)}></div>
        <div className="w-12  border-2 border-red-400 text-center" ref={(div) => (matrixRef.current[0][1] = div)}></div>
        <div className="w-12  border-2 border-red-400 text-center" ref={(div) => (matrixRef.current[0][1] = div)}></div>
        <div className="w-12  border-2 border-red-400 text-center" ref={(div) => (matrixRef.current[0][1] = div)}></div>
        <div className="w-12  border-2 border-red-400 text-center" ref={(div) => (matrixRef.current[0][1] = div)}></div>
