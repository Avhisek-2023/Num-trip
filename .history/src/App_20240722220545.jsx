...
const App = () => {
  ...
  const nameClass = (e) => {
    if (e == 2) {
      return "px-6 py-4 m-1 text-md text-red-500 font-bold text-center transition duration-500 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200";
    } else if (e == 4) {
      return "px-6 py-4 m-1 text-md text-yellow-500 font-bold text-center transition duration-500 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200";
    } else {
      return "px-6 py-4 m-1 text-md text-green-500 font-bold text-center transition duration-500 ease-in-out bg-blue-100 border-2 border-blue-900 rounded-full cursor-pointer hover:bg-indigo-200";
    }
  };
  return loading ? (
    <>Loading..</>
