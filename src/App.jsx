...
const App = () => {
  ...
  //     </div>
  //     <div className="container max-w-4xl p-4 mx-auto md:p-6 lg:p-8">
  //       <div className="p-2 mx-auto border-4 shadow-xl shadow-cyan-900 border-cyan-800 bg-slate-300 rounded-xl md:w-3/4 lg:w-1/2">
  //         {twoDValue.map((row, i) => (
  ...
  //         ))}
  //       </div>
  //       {modal && <Modal highest={highest} shuffle2D={shuffle2D} life={life} />}
  //     </div>
  //   </div>
  // );
  ...
  return loading ? (
    ...
    <div className="overflow-x-hidden antialiased text-neutral-300">
      ...
      <div className="container flex flex-col items-center justify-center w-full h-auto my-40 lg:my-32 lg:ml-20">
        <h1 className="numtrip-title">
          <span>N</span>
          <span>U</span>
          <span>M</span>
          <span>T</span>
        ...
        <div className="p-2 mt-8 border-4 shadow-xl shadow-cyan-900 border-cyan-800 bg-slate-300 rounded-xl">
          {twoDValue.map((row, i) => (
            <div className="flex w-full lg:w-full " key={i}>
              {row.map((e, j) => (
                <Cell
                  key={j}
                  number={e}
